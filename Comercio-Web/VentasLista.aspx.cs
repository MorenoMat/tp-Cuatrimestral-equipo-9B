...
namespace Comercio_Web
{
    public partial class VentasLista : System.Web.UI.Page
    {
        ...
        private void cargarGrilla(string busquedaVenta = null, string busquedaFactura = null, DateTime? fechaDesde = null, DateTime? fechaHasta = null)
        {
            ...
            bool hayFiltros = !string.IsNullOrWhiteSpace(busquedaVenta)
                || !string.IsNullOrWhiteSpace(busquedaFactura)
                || idCliente > 0
                || idUsuario > 0
                || fechaDesde.HasValue
                || fechaHasta.HasValue;
            TablaSinResultadosHelper.Aplicar(dgvVentas, hayFiltros);
        ...
        protected string ObtenerUrlDetalle(object idVenta)
        {
            return "VentasDetalle.aspx?id=" + idVenta + "&pagina=" + PaginaActual + "&tamanio=" + TamanioPagina;
        }
    }
}
