...
INSERT INTO Compras (idProveedor, idUsuario, fechaCompra, total, estado) VALUES 
    (1, 1, '2023-08-05', 540000.00, 'Finalizada'),
    (2, 1, '2023-08-12', 420000.00, 'Finalizada'),
    (3, 2, '2023-08-20', 385000.00, 'Finalizada'),
    (1, 2, '2023-09-03', 625000.00, 'Finalizada'),
    (4, 3, '2023-09-10', 295000.00, 'Finalizada'),
    (5, 1, '2023-09-18', 480000.00, 'Finalizada'),
    (2, 3, '2023-09-25', 350000.00, 'Finalizada'),
    (6, 2, '2023-10-02', 410000.00, 'Finalizada'),
    (3, 1, '2023-10-09', 525000.00, 'Finalizada'),
    (1, 3, '2023-10-16', 680000.00, 'Finalizada'),
    (7, 2, '2023-10-23', 245000.00, 'Finalizada'),
    (4, 1, '2023-10-30', 315000.00, 'Finalizada'),
    (5, 3, '2023-11-06', 580000.00, 'Finalizada'),
    (2, 2, '2023-11-13', 395000.00, 'Finalizada'),
    (8, 1, '2023-11-20', 465000.00, 'Finalizada'),
    (1, 3, '2023-11-27', 720000.00, 'Finalizada'),
    (3, 2, '2023-12-04', 385000.00, 'Finalizada'),
    (6, 1, '2023-12-11', 510000.00, 'Finalizada'),
    (4, 3, '2023-12-18', 275000.00, 'Finalizada'),
    (2, 2, '2023-12-26', 445000.00, 'Finalizada'),
    (5, 1, '2024-01-08', 625000.00, 'Finalizada'),
    (1, 3, '2024-01-15', 580000.00, 'Finalizada'),
    (7, 2, '2024-01-22', 320000.00, 'Finalizada'),
    (3, 1, '2024-01-29', 495000.00, 'Finalizada'),
    (8, 3, '2024-02-05', 410000.00, 'Finalizada'),
    (2, 2, '2024-02-12', 535000.00, 'Finalizada'),
    (6, 1, '2024-02-19', 385000.00, 'Finalizada'),
    (4, 3, '2024-02-26', 295000.00, 'Finalizada'),
    (1, 2, '2024-03-04', 670000.00, 'Finalizada'),
    (5, 1, '2024-03-11', 525000.00, 'Finalizada'),
    (3, 3, '2024-03-18', 445000.00, 'Finalizada'),
    (2, 2, '2024-03-25', 380000.00, 'Finalizada'),
    (7, 1, '2024-04-01', 315000.00, 'Finalizada'),
    (8, 3, '2024-04-08', 485000.00, 'Finalizada'),
    (1, 2, '2024-04-15', 595000.00, 'Finalizada'),
    (4, 1, '2024-04-22', 340000.00, 'Finalizada'),
    (6, 3, '2024-04-29', 425000.00, 'Finalizada'),
    (2, 2, '2024-05-06', 510000.00, 'Finalizada'),
    (5, 1, '2024-05-13', 465000.00, 'Pendiente'),
    (3, 3, '2024-05-20', 385000.00, 'Pendiente');
...
INSERT INTO Ventas (idCliente, idUsuario, fechaVenta, total, numeroFactura) VALUES 
    (1, 2, '2023-09-01', 106250.00, 1001), (2, 3, '2023-09-02', 156000.00, 1002),
    (3, 2, '2023-09-03', 114000.00, 1003), (4, 4, '2023-09-05', 85200.00, 1004),
    (5, 2, '2023-09-07', 234000.00, 1005), (6, 3, '2023-09-09', 52500.00, 1006),
    (7, 4, '2023-09-11', 156000.00, 1007), (8, 2, '2023-09-13', 168750.00, 1008),
    (9, 3, '2023-09-15', 91200.00, 1009), (10, 4, '2023-09-17', 175500.00, 1010),
    (11, 2, '2023-09-19', 138000.00, 1011), (12, 3, '2023-09-21', 60750.00, 1012),
    (13, 4, '2023-09-23', 114000.00, 1013), (14, 2, '2023-09-25', 202800.00, 1014),
    (15, 3, '2023-09-27', 98400.00, 1015), (16, 4, '2023-09-29', 127500.00, 1016),
    (17, 2, '2023-10-01', 175500.00, 1017), (18, 3, '2023-10-03', 83200.00, 1018),
    (19, 4, '2023-10-05', 156000.00, 1019), (20, 2, '2023-10-07', 201600.00, 1020),
    (21, 3, '2023-10-09', 91200.00, 1021), (22, 4, '2023-10-11', 138000.00, 1022),
    (23, 2, '2023-10-13', 168750.00, 1023), (24, 3, '2023-10-15', 54600.00, 1024),
    (25, 4, '2023-10-17', 106250.00, 1025), (26, 2, '2023-10-19', 234000.00, 1026),
    (27, 3, '2023-10-21', 127500.00, 1027), (28, 4, '2023-10-23', 175500.00, 1028),
    (29, 2, '2023-10-25', 98400.00, 1029), (30, 3, '2023-10-27', 156000.00, 1030),
    (1, 4, '2023-10-29', 83200.00, 1031), (2, 2, '2023-10-31', 114000.00, 1032),
    (3, 3, '2023-11-02', 202800.00, 1033), (4, 4, '2023-11-04', 91200.00, 1034),
    (5, 2, '2023-11-06', 138000.00, 1035), (6, 3, '2023-11-08', 168750.00, 1036),
    (7, 4, '2023-11-10', 60750.00, 1037), (8, 2, '2023-11-12', 156000.00, 1038),
    (9, 3, '2023-11-14', 175500.00, 1039), (10, 4, '2023-11-16', 106250.00, 1040),
    (11, 2, '2023-11-18', 234000.00, 1041), (12, 3, '2023-11-20', 127500.00, 1042),
    (13, 4, '2023-11-22', 98400.00, 1043), (14, 2, '2023-11-24', 156000.00, 1044),
    (15, 3, '2023-11-26', 83200.00, 1045), (16, 4, '2023-11-28', 114000.00, 1046),
    (17, 2, '2023-11-30', 202800.00, 1047), (18, 3, '2023-12-02', 91200.00, 1048),
    (19, 4, '2023-12-04', 138000.00, 1049), (20, 2, '2023-12-06', 168750.00, 1050),
    (21, 3, '2023-12-08', 175500.00, 1051), (22, 4, '2023-12-10', 106250.00, 1052),
    (23, 2, '2023-12-12', 234000.00, 1053), (24, 3, '2023-12-14', 127500.00, 1054),
    (25, 4, '2023-12-16', 98400.00, 1055), (26, 2, '2023-12-18', 156000.00, 1056),
    (27, 3, '2023-12-20', 83200.00, 1057), (28, 4, '2023-12-22', 114000.00, 1058),
    (29, 2, '2023-12-24', 202800.00, 1059), (30, 3, '2023-12-26', 91200.00, 1060),
    (1, 4, '2024-01-02', 138000.00, 1061), (2, 2, '2024-01-04', 168750.00, 1062),
    (3, 3, '2024-01-06', 175500.00, 1063), (4, 4, '2024-01-08', 106250.00, 1064),
    (5, 2, '2024-01-10', 234000.00, 1065), (6, 3, '2024-01-12', 127500.00, 1066),
    (7, 4, '2024-01-14', 98400.00, 1067), (8, 2, '2024-01-16', 156000.00, 1068),
    (9, 3, '2024-01-18', 83200.00, 1069), (10, 4, '2024-01-20', 114000.00, 1070),
    (11, 2, '2024-01-22', 202800.00, 1071), (12, 3, '2024-01-24', 91200.00, 1072),
    (13, 4, '2024-01-26', 138000.00, 1073), (14, 2, '2024-01-28', 168750.00, 1074),
    (15, 3, '2024-01-30', 175500.00, 1075), (16, 4, '2024-02-01', 106250.00, 1076),
    (17, 2, '2024-02-03', 234000.00, 1077), (18, 3, '2024-02-05', 127500.00, 1078),
    (19, 4, '2024-02-07', 98400.00, 1079), (20, 2, '2024-02-09', 156000.00, 1080);
